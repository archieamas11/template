...
import { Sparkles } from 'lucide-react'; // ✨ Lucide icon import
		...
		<div className="flex min-h-screen items-center justify-center">
			<Card className="mx-auto w-full max-w-sm p-8">
				<div className="mb-8 flex flex-col items-center">
					<a className="mb-4" href="/" tabIndex={0}>
						<div className="rounded-lg border border-primary bg-accent p-2">
							<Sparkles aria-label="Logo" className="text-white" size={30} />
						</div>
					</a>
					<h1 className="font-bold text-2xl tracking-tight">Sign in to your account</h1>
					<p className="mt-1 text-muted-foreground text-sm">Welcome back! Please enter your credentials.</p>
				</div>
